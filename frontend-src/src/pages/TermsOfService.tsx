        ...
        <div className="prose prose-blue max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              By accessing and using Warden ("the Platform"), you accept and agree to be bound by the terms and 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Warden is a collaborative platform for creative writing, storytelling, and community building. 
              The Platform allows users to:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Create and share written content</li>
              <li>Join and participate in creative groups</li>
              <li>Collaborate with other writers</li>
              <li>Engage in discussions and feedback</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              By posting User Content, you grant Warden a non-exclusive, worldwide, royalty-free license to:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              <li>Display, reproduce, and distribute your content on the Platform</li>
              <li>Make your content available to other users as per your sharing settings</li>
              <li>Create backups and derivative works necessary for Platform operation</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-3">4.2 Content Responsibility</h3>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Your content complies with all applicable laws and our House Rules</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              personal information. By using the Platform, you consent to our privacy practices.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The Platform and its original content, features, and functionality are owned by Warden and are 
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Violations of our House Rules</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, WARDEN SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              changes via email or through the Platform. Your continued use of the Platform after changes constitutes 
