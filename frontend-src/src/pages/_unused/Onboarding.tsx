...
export default function Onboarding() {
  ...
  newErrors.push({ field: 'phoneNumber', message: 'Please enter a valid phone number (e.g., +1 555 000 0000)' });
    ...
    if (!formData.birthYear) {
      ...
      newErrors.push({ field: 'birthYear', message: 'You must be at least 18 years old to use Warden' });
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to Warden! 🎉</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 3 && (
            <div className="bg-white rounded-lg p-8 max-w-2xl mx-auto shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Welcome to Warden Chat!</h2>
